 ...
 * 1. Ouvrir l'application CalyCompta dans le navigateur (https://caly-compta.vercel.app)
...
(async function deleteIncompleteDemandes() {
  ...
  if (!window.db) {
    ...
    console.error('💡 Assurez-vous d\'être sur l\'application CalyCompta (https://caly-compta.vercel.app)');
