...
1. **Render template and save to HTML**:
   ...
   ```
   Output: `calycompta-app/output/template-abc123-[timestamp].html`
...
- `serviceAccountKey.json` in `calycompta-app/` directory
...
**Location:** `calycompta-app/functions/src/index.ts`
